...
#+TITLE: Observations of Emoji and Group Identity on Twitter
...
|-----------------+---------+-----------|
| listed_count    |  0.0423 |  478001.5 |
| followers_count |     0.0 |  373393.5 |
| friends_count   |     0.0 |  397093.0 |

[[tbl:mann]] suggests statistical significance between the sample
and control groups for the number of lists in which users appear,
the number of accounts users follow, and the number of followers
for each user.
